 ...
 * Author: KO
 *
 * Created on June 24, 2020, 5:59 PM
 */
...
void main()
{
    ...
    while(1)
    {
        Lcd_Clear();
        I2C_Start();
        I2C_Write(0x9A|0x00);  // TC74 slave address 
        I2C_Write(0x00);  // TC74 command byte where data should write
        I2C_Stop();
        ...
        I2C_Write(0x00);  // TC74 command byte where data should write
        I2C_RepeatedStart();      
        I2C_Write(0x9A|0x01);  // TC74 slave address with read bit 
        data = I2C_Read(0);    // Read data and send acknowledge
        I2C_Stop();
