...
// Assign first node address to the last node of next pointer 
    temp->next = head;
/**************************************************************************************
* Assign last node address to the first node of previous pointer.
* For that first point the head to the first node by assigning temp which holding 
* first node address to the head
**************************************************************************************/
    temp = head;
...
{
    temp = head;
    printf("\n\nSINGLY LINKED LIST-->Next pointer variable, so data will be straight: ");
...
// so this if statement is to avoid the storing of NULL into head
    ...
    printf("\n\nDOUBLY LINKED LIST-->Previous pointer variable, so data will be reverse: ");
    for(i=routine; i>0; i--)
    {
    ...
    printf("\n\nDOUBLY CIRCULAR LINKED LIST-->PREVIOUS pointer variable, so data will be reverse: ");
    for(i=routine; i>=0; i--)
    {
        printf("\n\nExpected Current->%d value = %f", i, temp->ExI);
        printf("\nVoltage->%d value = %f", i, temp->V);
